...
public class Newyeargiftbox 
{
    ...
    { 
        ...
        System.out.println("2.RedVelvet!!");
        System.out.println("3.Truffles!!");
        System.out.println("4.SugarCandies!!");
        System.out.println("5.GummyBears!!");
        System.out.println("6.SugarCookies!!");
        ...
        case '2':
        	   ...
        	   System.out.println("please enter the weight in grams");
        	   weight=sc.nextInt();
        	   collect=new RedVelvet();
        	   total_weight=collect.calcwt(quantity, weight);
        	   totalbox_wt=totalbox_wt+total_weight;

        	   System.out.println("total weight of RedVelvet is:"+total_weight+"grams");
        	   System.out.println("Total weight of gift box is:"+totalbox_wt+"grams");
        	   System.out.println("do you want any other item (y/n)");
        	   n1=sc.next().charAt(0);
        	      if(n1=='y'|| n1=='Y')
        ...
        case '3':
        	...
        	System.out.println("please enter the weight in grams");
        	weight=sc.nextInt();
        	collect=new Truffles();
        	total_weight=collect.calcwt(quantity, weight);
        	totalbox_wt=totalbox_wt+total_weight;

        	System.out.println("total weight of Truffles is:"+total_weight+"grams");
        	System.out.println("Total weight of gift box is:"+totalbox_wt+"grams");
        	System.out.println("do you want any other item (y/n)");
        	n1=sc.next().charAt(0);
        	if(n1=='y'|| n1=='Y')
        ...
        case '4':
        	...
        	System.out.println("please enter the weight in grams");
        	weight=sc.nextInt();
        	collect=new SugarCandies();
        	total_weight=collect.calcwt(quantity, weight);
        	totalbox_wt=totalbox_wt+total_weight;
        	total_candies=total_candies+quantity;

        	System.out.println("total weight of SugarCandies is:"+total_weight+"grams");
        	System.out.println("Total weight of gift box is:"+totalbox_wt+"grams");
        	System.out.println("do you want any other item (y/n)");
        	n1=sc.next().charAt(0);
        	if(n1=='y'|| n1=='Y')
        ...
        case '5':
        	...
        	System.out.println("please enter the weight in grams");
        	weight=sc.nextInt();
        	collect=new GummyBears();
        	total_weight=collect.calcwt(quantity, weight);
        	totalbox_wt=totalbox_wt+total_weight;

        	System.out.println("total weight of GummyBears is:"+total_weight+"grams");
        	System.out.println("Total weight of gift box is:"+totalbox_wt+"grams");
        	System.out.println("do you want any other item (y/n)");
        	n1=sc.next().charAt(0);
        	if(n1=='y'|| n1=='Y')
        ...
        case '6':
        	...
        	System.out.println("please enter the weight in grams");
        	weight=sc.nextInt();
        	collect=new SugarCookies();
        	total_weight=collect.calcwt(quantity, weight);
        	totalbox_wt=totalbox_wt+total_weight;

        	System.out.println("total weight of SugarCookies is:"+total_weight+"grams");
        	System.out.println("Total weight of gift box is:"+totalbox_wt+"grams");
        	System.out.println("do you want any other item (y/n)");
        	n1=sc.next().charAt(0);
        	if(n1=='y'|| n1=='Y')
